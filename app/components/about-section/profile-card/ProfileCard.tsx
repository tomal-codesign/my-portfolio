...
const ProfileCard = ({ classNameprops }: props) => {
    return (
        <>
            <SpotlightCard className={`${classNameprops} custom-spotlight-card bg-white/40 p-[40px] border border-[#fff]/80 rounded-[46px] backdrop-blur-lg`} spotlightColor="rgba(67, 0, 255, 0.3)">
                <div className="flex flex-col gap-4 w-full items-center relative z-10">
                    ...
                    <div className="flex gap-4 items-center" >
                        ...
                        <SocialButton icon='bxl:github' iconColor="bg-[#000]" hoverColor='hover:bg-[#000]' text='Github' link='https://github.com/' />
                        <SocialButton icon='bxl:dribbble' iconColor="bg-[#ea4c89]" hoverColor='hover:bg-[#ea4c89]' text='Dribbble' link='https://dribbble.com/' />
                        <SocialButton icon='la:linkedin-in' iconColor="bg-[#0a66c2]" hoverColor='hover:bg-[#0a66c2]' text='Linkedin' link='https://www.linkedin.com/' />
                    </div>
                </div>
            </SpotlightCard>
        </>
