...
const ProfileCard = ({ classNameprops }: props) => {
    return (
        <>
            <SpotlightCard data-aos="fade-up" className={`${classNameprops} custom-spotlight-card bg-white/40 p-[30px] lg:p-[40px] border border-[#fff]/80 rounded-[46px] backdrop-blur-lg`} spotlightColor="rgba(67, 0, 255, 0.3)">
