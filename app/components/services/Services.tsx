            ...
            <div className='pt-8'>
                <div className='container mx-auto px-4'>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div className='custom-spotlight-card rounded-[46px] backdrop-blur-lg lg:sticky top-[40px] left-0 lg:h-[300px] h-auto lg:pr-[100px]'>
                            <h1 className="text-[var(--normal-text)] text-[20px] lg:text-[40px] font-extrabold">My Eyes to do</h1>
                            <p className="pt-1 text-[var(--normal-text)] text-sm lg:text-md">An Addicted, Specialized, and Qualified to build UI/UX design for website  and mobile applications (Dealing with the front end part). I always work with the need to understand the benefits of the users, give them  something new to enjoy, and come close to new expectations in advance.</p>
                        </div>
