                ...
                <div className='container mx-auto px-4'>
                    <div className="grid grid-cols-2 gap-6">
                        <div className='custom-spotlight-card bg-white/40 lg:p-[40px] p-4 border border-[#fff]/80 rounded-[46px] backdrop-blur-lg'>
                            <h1 className="text-[var(--normal-text)] text-[40px] font-extrabold">Working</h1>
                            <p className="pt-1 text-[var(--normal-text)] text-md">Code that speaks. Design that connects</p>
