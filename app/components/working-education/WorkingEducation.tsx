                ...
                <div className='container mx-auto px-4'>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div className='custom-spotlight-card bg-white/40 p-[30px] lg:p-[40px] p-4 border border-[#fff]/80 rounded-[46px] backdrop-blur-lg'>
                            ...
                            <p className="pt-1 text-[var(--normal-text)] text-sm lg:text-md">Code that speaks. Design that connects</p>
                        ...
                        <div className='custom-spotlight-card bg-white/40 p-[30px] lg:p-[40px] p-4 border border-[#fff]/80 rounded-[46px] backdrop-blur-lg'>
                            ...
                            <p className="pt-1 text-[var(--normal-text)] text-sm lg:text-md">Where academic foundation meets real-world implementation</p>
                            <div className='flex flex-col lg:pt-10 pt-6 gap-4'>
