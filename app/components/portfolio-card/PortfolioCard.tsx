...
const PortfolioCard = ({ img, title }: Props) => {
    return (
        <div className='overflow-hidden relative custom-spotlight-card p-4 bg-white/40 border border-[#fff]/80 rounded-[46px] backdrop-blur-lg group' >
            <div className='h-[200px] lg:h-[330px] overflow-hidden rounded-[30px] hover-group relative'>
                ...
                <div className='hover-group:opacity-0 absolute top-0 left-0 w-full h-full bg-black/20 flex justify-center items-center'>
